            ...
            <div class="upcoming-shifts">
              <div class="shift-item" *ngFor="let shift of upcomingShifts">
                <div class="shift-date-badge">
                  <div class="date-day">{{ shift.day }}</div>
                  <div class="date-month">{{ shift.month }}</div>
                </div>
...
export class DoctorDashboardComponent {
  financialSummary: FinancialSummary[] = [
    { title: 'Ganhos do Mês', value: 'R$ 14.400', icon: '💰', subtitle: 'Novembro 2025' },
    { title: 'Horas do Mês', value: '144h', icon: '⏱️', subtitle: '12 plantões' },
    { title: 'Próximo Plantão', value: '25/11', icon: '📅', subtitle: 'Hospital São Lucas' },
    { title: 'Taxa de Aceitação', value: '87%', icon: '✅', subtitle: 'Últimos 30 dias' }
  ];

  upcomingShifts = [
    { day: '25', month: 'NOV', hospital: 'Hospital São Lucas', time: '08:00 - 20:00', specialty: 'Cardiologia', value: 1200 },
    { day: '27', month: 'NOV', hospital: 'Hospital Central', time: '14:00 - 22:00', specialty: 'Emergência', value: 1500 },
    { day: '29', month: 'NOV', hospital: 'Clínica Santa Maria', time: '08:00 - 16:00', specialty: 'Cardiologia', value: 1000 }
  ];
  ...
  recentActivity = [
    ...
    { icon: '✅', title: 'Plantão Concluído', description: 'Hospital São Lucas - 23/11', time: 'Há 1 dia', color: '#e8f5e9' }
  ];
